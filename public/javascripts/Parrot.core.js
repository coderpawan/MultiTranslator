...
(function () {
   ...
   * @param isJson
   */
  eParrot.prototype.request = function (
    url,
    type,
    successHandler,
    errorHandler,
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.readyState == 4) {
        ...
        if (status >= 200 && status < 400) {
          data =
            typeof isJson != "undefined" && isJson == true
  ...
  eParrot.prototype.gTranslator = function (t) {
    this.request(
      "https://multitalk.netlify.app/g-translator/result?q=" +
        encodeURIComponent(t) +
        "&tl=" +
        encodeURIComponent(
          voiceSelect.options[voiceSelect.selectedIndex].getAttribute("lang")
        ),
      "GET",
      function (d) {
  ...
  eParrot.prototype.isSupported = function () {
    if (speechSynthesisSupported && webkitSpeechRecognitionisSupported) {
      supportMessageEle.innerHTML =
        "Your browser <strong>supports</strong> the speech synthesis and Web Speech API.";
    } else {
      supportMessageEle.innerHTML =
        "Your browser <strong>does not support</strong> speech synthesis and Web Speech API.";
      this.notify("error");
    }
  };
  ...
  eParrot.prototype.Events = {
    ...
    error: function (e) {
      ...
      if (e.error == "no-speech") {
        Typed.new("#support-message", {
          strings: [
            '<strong>No speech was detected.</strong> You may need to adjust your <a href="//support.google.com/chrome/bin/answer.py?hl=en&amp;answer=1407892">microphonesettings</a>.',
          ],
          typeSpeed: 0,
          loop: true,
        });
      ...
      if (e.error == "audio-capture") {
        Typed.new("#support-message", {
          strings: [
            '<strong>No microphone was found.</strong> Ensure that a microphone is installed and that <a href="//support.google.com/chrome/bin/answer.py?hl=en&amp;answer=1407892">microphone settings</a> are configured correctly.',
          ],
          typeSpeed: 0,
          loop: true,
        });
      ...
      if (e.error == "not-allowed") {
        if (e.timeStamp - eParrot.prototype.temp.start_timestamp < 100) {
          Typed.new("#support-message", {
            strings: [
              "<strong>Permission to use microphone is blocked.</strong> To change, go to chrome://settings/contentExceptions#media-stream",
            ],
            typeSpeed: 0,
            loop: true,
          });
          ...
          Typed.new("#support-message", {
            strings: [
              "<strong>Permission to use microphone was denied.</strong>",
            ],
            typeSpeed: 0,
            loop: true,
          });
